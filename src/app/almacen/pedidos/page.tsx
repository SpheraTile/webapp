                ...
                <div key={pedido.id} className="p-4">
                  <div className="flex items-start justify-between mb-2">
                    <div>
                      ...
                      <div className="text-sm text-neutral-500">{pedido.user.nombre}</div>
                    </div>
                    <EstadoBadge estado={pedido.estado} />
                  </div>
                  <div className="flex items-center justify-between text-sm mb-3">
                    <span className="text-neutral-500">{formatDate(pedido.createdAt)}</span>
                    <span className="font-semibold text-neutral-900">{formatCurrency(pedido.total_euros)}</span>
                  </div>
                  ...
                  <Link
                    ...
                    className="block w-full py-2 text-center text-sm font-medium text-primary-600 bg-primary-50 rounded-lg hover:bg-primary-100 transition-colors"
                  >
                    Ver pedido
                  </Link>
                </div>
