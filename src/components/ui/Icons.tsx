// Iconos SVG para la aplicación SPHERA TILE
// Iconos minimalistas y consistentes con el diseño
...
export function IconGrid({ className = '', size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconQR({ className = '', size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconStock({ className = '', size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconCeramoteca({ className = '', size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path d="M5 5h3v3H5z" fill="currentColor" opacity="0.3" />
      <path d="M16 5h3v3h-3z" fill="currentColor" opacity="0.3" />
      <path d="M5 16h3v3H5z" fill="currentColor" opacity="0.3" />
      <path d="M16 16h3v3h-3z" fill="currentColor" opacity="0.3" />
    </svg>
  )
}
...
export function IconHelp({ className = '', size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
